...
final class VendorTransactionStatusSDK
{
     ...
     */
    public function getTransaction(AccessToken $accessToken, string $region, string $transaction_id) : \Plenty\AmazonPHP\SellingPartner\Model\VendorTransactionStatus\GetTransactionResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \Plenty\AmazonPHP\SellingPartner\Model\VendorTransactionStatus\GetTransactionResponse::class,
            []
        );
    }
