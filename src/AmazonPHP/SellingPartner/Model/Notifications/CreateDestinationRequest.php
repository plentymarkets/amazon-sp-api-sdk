 ...
 */
class CreateDestinationRequest implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
    ...
    protected static /** [COMPAT] array */ $openAPITypes = [
        'resource_specification' => \Plenty\AmazonPHP\SellingPartner\Model\Notifications\DestinationResourceSpecification::class,
        'name' => 'string',
    ];
