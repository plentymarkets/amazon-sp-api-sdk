 ...
 */
class InvalidASIN implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
     ...
     * @var string
     */
    protected static /** [COMPAT] string */ $openAPIModelName = 'InvalidASIN';
    ...
    protected static /** [COMPAT] array */ $openAPITypes = [
        'asin' => 'string',
        'error_reason' => \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound\ErrorReason::class,
    ];
