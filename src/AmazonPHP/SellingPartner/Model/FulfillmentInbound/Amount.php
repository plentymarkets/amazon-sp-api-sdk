 ...
 */
class Amount implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
    ...
    protected static /** [COMPAT] array */ $openAPITypes = [
        'currency_code' => \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound\CurrencyCode::class,
        'value' => 'double',
    ];
