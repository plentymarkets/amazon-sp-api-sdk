...
class Distance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Distance';
     ...
     * @return string[]
     */
    public function getDistanceUnitAllowableValues() : array
    {
        return [
     ...
     * Sets distance_unit
     *
     * @param string $distance_unit The unit of measurement of the distance.
     *
     * @return self
     */
    public function setDistanceUnit($distance_unit) : self
    {
        $allowedValues = $this->getDistanceUnitAllowableValues();
