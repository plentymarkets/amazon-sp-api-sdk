 ...
 */
class ItemImagesByMarketplace implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     * Sets images
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\CatalogItem\ItemImage[] $images Images for an item in the Amazon catalog, grouped by `marketplaceId`.
     *
     * @return self
     */
