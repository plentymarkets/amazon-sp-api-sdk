 ...
 */
class ItemContributor implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static array $openAPITypes = [
        'role' => \Plenty\AmazonPHP\SellingPartner\Model\CatalogItem\ItemContributorRole::class,
        'value' => 'string'
    ];
