 ...
 */
class ChargeDetails implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
    ...
    protected static /** [COMPAT] array */ $openAPITypes = [
        'type' => 'string',
        'description' => 'string',
        'charge_amount' => \Plenty\AmazonPHP\SellingPartner\Model\VendorInvoices\Money::class,
     ...
     * Sets tax_details.
     *
     * @param null|\Plenty\AmazonPHP\SellingPartner\Model\VendorInvoices\TaxDetails[] $tax_details tax amount details applied on this charge
     */
