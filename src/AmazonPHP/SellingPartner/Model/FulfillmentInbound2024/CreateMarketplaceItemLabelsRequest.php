...
class CreateMarketplaceItemLabelsRequest implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'height' => 'float',
        'label_type' => \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\LabelPrintType::class,
        'locale_code' => 'string',
        'marketplace_id' => 'string',
        'msku_quantities' => '\Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\MskuQuantity[]',
        'page_type' => \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\ItemLabelPageType::class,
        'width' => 'float',
    ];
