...
class TrackingDetailsInput implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'ltl_tracking_detail' => \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\LtlTrackingDetailInput::class,
        'spd_tracking_detail' => \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\SpdTrackingDetailInput::class,
    ];
    ...
    public function listInvalidProperties() : array
    {
        ...
        if ($this->container['ltl_tracking_detail'] !== null) {
            $this->container['ltl_tracking_detail']->listInvalidProperties();
        }

        if ($this->container['spd_tracking_detail'] !== null) {
            $this->container['spd_tracking_detail']->listInvalidProperties();
        }
