...
class OrderProceeds implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static array $openAPITypes = [
        'grand_total' => \Plenty\AmazonPHP\SellingPartner\Model\Orders2026\Money::class,
        'breakdowns' => '\Plenty\AmazonPHP\SellingPartner\Model\Orders2026\OrderProceedsBreakdown[]'
    ];
     ...
     * Sets grand_total
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\Orders2026\Money|null $grand_total grand_total
     *
     * @return self
     */
     ...
     * Gets breakdowns
     *
     * @return \Plenty\AmazonPHP\SellingPartner\Model\Orders2026\OrderProceedsBreakdown[]|null
     */
     ...
     * Sets breakdowns
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\Orders2026\OrderProceedsBreakdown[]|null $breakdowns Categorized proceeds for the order. Proceed categories are either aggregated across all order items (such as `ITEM`, `SHIPPING`, and `TAX`) or applied at the order level (such as `DELIVERY_TIP`).
     *
     * @return self
     */
