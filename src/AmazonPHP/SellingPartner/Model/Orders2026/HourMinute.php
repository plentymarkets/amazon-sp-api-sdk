 ...
 */
class HourMinute implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'HourMinute';
     ...
     * Sets hour
     *
     * @param int|null $hour The hour when the business opens or closes, in 24-hour format (0-23).
     *
     * @return self
     */
