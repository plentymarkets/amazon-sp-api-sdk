 ...
 */
class PackageItem implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PackageItem';
     ...
     * Sets order_item_id
     *
     * @param string $order_item_id Unique identifier of the order item included in this package.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $transparency_codes The transparency codes associated with this item for product authentication.
     *
     * @return self
     */
