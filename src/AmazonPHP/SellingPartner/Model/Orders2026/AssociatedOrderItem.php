 ...
 */
class AssociatedOrderItem implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AssociatedOrderItem';
     ...
     * Sets order_id
     *
     * @param string|null $order_id The order identifier of the associated order item.
     *
     * @return self
     */
     ...
     * Sets order_item_id
     *
     * @param string|null $order_item_id The order item identifier of the associated order item.
     *
     * @return self
     */
     ...
     *
     * @param string|null $association_type The type of association between the order items.  **Possible values**: - `VALUE_ADD_SERVICE` (The associated item is a service order)
     *
     * @return self
     */
