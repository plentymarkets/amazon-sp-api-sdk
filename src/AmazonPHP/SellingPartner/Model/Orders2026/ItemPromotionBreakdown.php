 ...
 */
class ItemPromotionBreakdown implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemPromotionBreakdown';
     ...
     * Sets promotion_id
     *
     * @param string|null $promotion_id Unique identifier for the promotion applied to this item.
     *
     * @return self
     */
