 ...
 */
class ItemInternationalShipping implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemInternationalShipping';
     ...
     * Sets ioss_number
     *
     * @param string|null $ioss_number Import One-Stop Shop registration number required for EU VAT compliance when shipping from outside the European Union. Sellers shipping to the EU from outside the EU must provide this IOSS number to their carrier when Amazon has collected the VAT on the sale.
     *
     * @return self
     */
