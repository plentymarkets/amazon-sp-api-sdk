 ...
 */
class ItemCancellationExecution implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemCancellationExecution';
    ...
    {
        $this->container['cancelled_by'] = $data['cancelled_by'] ?? null;
     ...
     * Sets cancelled_by
     *
     * @param string|null $cancelled_by Entity that executed the cancellation for this item.   **Possible values**: `BUYER`, `MERCHANT`, `AMAZON`
     *
     * @return self
     */
     ...
     * Sets cancel_reason
     *
     * @param string|null $cancel_reason Explanation provided for why the cancellation was executed.
     *
     * @return self
     */
