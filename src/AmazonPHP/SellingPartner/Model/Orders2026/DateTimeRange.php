 ...
 */
class DateTimeRange implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static array $attributeMap = [
        'earliest_date_time' => 'earliestDateTime',
        'latest_date_time' => 'latestDateTime'
    ];
     ...
     *
     * @param \DateTime|null $earliest_date_time The beginning of the time period, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     *
     * @return self
     */
    public function setEarliestDateTime($earliest_date_time) : self
    {
     ...
     *
     * @param \DateTime|null $latest_date_time The end of the time period, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     *
     * @return self
     */
    public function setLatestDateTime($latest_date_time) : self
    {
