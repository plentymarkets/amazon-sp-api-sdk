 ...
 */
class ItemCustomization implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemCustomization';
     ...
     * Sets customized_url
     *
     * @param string|null $customized_url The URL of the customized data for custom orders from the Amazon Custom program.
     *
     * @return self
     */
