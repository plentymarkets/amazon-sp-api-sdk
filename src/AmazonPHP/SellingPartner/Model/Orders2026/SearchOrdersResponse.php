...
class SearchOrdersResponse implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     * Gets orders
     *
     * @return \Plenty\AmazonPHP\SellingPartner\Model\Orders2026\Order[]
     */
     ...
     * Sets orders
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\Orders2026\Order[] $orders An array containing all orders that match the search criteria.
     *
     * @return self
     */
     ...
     * Gets pagination
     *
     * @return \Plenty\AmazonPHP\SellingPartner\Model\Orders2026\Pagination|null
     */
     ...
     * Sets pagination
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\Orders2026\Pagination|null $pagination pagination
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_updated_before Only orders updated before the specified time are returned. The date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     *
     * @return self
     */
     ...
     * Sets created_before
     *
     * @param \DateTime|null $created_before Only orders placed before the specified time are returned. The date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     *
     * @return self
     */
