 ...
 */
class RelatedIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     *
     * @param string|null $related_identifier_name An enumerated set of related business identifier names.
     *
     * @return self
     */
