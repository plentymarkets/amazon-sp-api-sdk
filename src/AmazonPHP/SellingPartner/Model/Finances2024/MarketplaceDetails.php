 ...
 */
class MarketplaceDetails implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     *
     * @param string|null $marketplace_name The name of the marketplace where the transaction occurred. For example: `Amazon.com`,`Amazon.in`
     *
     * @return self
     */
