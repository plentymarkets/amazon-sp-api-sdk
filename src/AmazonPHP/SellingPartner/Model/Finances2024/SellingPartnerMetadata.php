 ...
 */
class SellingPartnerMetadata implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     *
     * @param string|null $selling_partner_id A unique seller identifier.
     *
     * @return self
     */
     ...
     * Sets account_type
     *
     * @param string|null $account_type The type of account in the transaction.
     *
     * @return self
     */
     ...
     * Sets marketplace_id
     *
     * @param string|null $marketplace_id The identifier of the marketplace where the transaction occurred. The marketplace ID is the globally unique identifier of a marketplace. To find the ID for your marketplace, refer to [Marketplace IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids).
     *
     * @return self
     */
