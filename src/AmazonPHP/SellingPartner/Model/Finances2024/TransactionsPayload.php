 ...
 */
class TransactionsPayload implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static array $openAPITypes = [
        'next_token' => 'string',
        'transactions' => 'Plenty\AmazonPHP\SellingPartner\Model\Finances2024\Transaction[]'
    ];
     ...
     * Sets transactions
     *
     * @param \AmazonPHP\SellingPartner\Model\Finances2024\Transaction[]|null $transactions A list of transactions within the specified time period.
     *
     * @return self
     */
