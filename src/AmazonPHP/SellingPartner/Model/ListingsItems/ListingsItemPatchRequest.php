 ...
 */
class ListingsItemPatchRequest implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
     ...
     * @var string
     */
    protected static /** [COMPAT] string */ $openAPIModelName = 'ListingsItemPatchRequest';
     ...
     * Sets patches.
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\ListingsItems\PatchOperation[] $patches one or more JSON Patch operations to perform on the listings item
     */
