 ...
 */
class ItemOffersResponseAllOf implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
     ...
     * @var string
     */
    protected static /** [COMPAT] string */ $openAPIModelName = 'ItemOffersResponse_allOf';
