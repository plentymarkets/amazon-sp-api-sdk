 ...
 */
class SmallAndLightFeePreviews implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
     ...
     * @var string
     */
    protected static /** [COMPAT] string */ $openAPIModelName = 'SmallAndLightFeePreviews';
