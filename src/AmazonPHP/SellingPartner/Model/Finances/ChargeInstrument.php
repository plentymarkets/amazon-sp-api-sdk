 ...
 */
class ChargeInstrument implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
     ...
     * @var string
     */
    protected static /** [COMPAT] string */ $openAPIModelName = 'ChargeInstrument';
    ...
    protected static /** [COMPAT] array */ $openAPITypes = [
        'description' => 'string',
        'tail' => 'string',
        'amount' => \Plenty\AmazonPHP\SellingPartner\Model\Finances\Currency::class,
    ];
