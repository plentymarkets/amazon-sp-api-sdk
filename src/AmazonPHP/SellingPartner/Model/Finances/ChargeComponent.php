 ...
 */
class ChargeComponent implements \ArrayAccess, \JsonSerializable, ModelInterface, \Stringable
{
     ...
     * @var string
     */
    protected static /** [COMPAT] string */ $openAPIModelName = 'ChargeComponent';
    ...
    protected static /** [COMPAT] array */ $openAPITypes = [
        'charge_type' => 'string',
        'charge_amount' => \Plenty\AmazonPHP\SellingPartner\Model\Finances\Currency::class,
    ];
